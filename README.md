...
> [!IMPORTANT]
> Сейчас репозиторий находится на стадии локального web MVP. Реализован приватный поиск по CSV-файлам из `data/`, JSON API и пользовательский интерфейс. Автоматический сбор данных и промышленная база данных пока отсутствуют.
...
Текущие данные находятся в `data/` и содержат 12 снимков конкурсных списков за июль 2026 года. Общий просмотр и скачивание этих таблиц через сайт отсутствуют.
...
- названия вузов отсутствуют в исходных файлах и не могут быть достоверно показаны;
